...
def get_3d_joints(body_handle):
    joints_3d = []
    confidence_levels = []
    for joint in body_handle.skeleton.joints:
        joints_3d.append(
            [joint.position.xyz.x, joint.position.xyz.y, joint.position.xyz.z]
        )
        confidence_levels.append(joint.confidence_level)

    return joints_3d, confidence_levels
